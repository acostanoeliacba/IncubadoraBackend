...
-- Tiempo de generación: 03-06-2025 a las 14:53:55
...
--
-- Base de datos: `NOC-V3`
--
CREATE DATABASE IF NOT EXISTS `NOC-V3` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `NOC-V3`;
...
(1, 1, 'Módulo 1', 'Introducción a la Carpintería', 'pdf', 'https://example.com/carpinteria/intro.pdf', '2025-06-01'),
(2, 2, 'Módulo 1', 'Fundamentos del Diseño Gráfico', 'canva', 'https://canva.com/diseno/modulo1', '2025-06-01'),
(3, 3, 'Módulo 1', 'Conceptos básicos de Informática', 'docx', 'https://example.com/informatica/basico.docx', '2025-06-01'),
(4, 4, 'Módulo 1', 'Motores y su funcionamiento', 'mp4', 'https://example.com/mecanica/motor.mp4', '2025-06-01'),
(5, 5, 'Módulo 1', 'Primeros pasos en Oratoria', 'pptx', 'https://example.com/oratoria/pasos.pptx', '2025-06-01'),
(6, 6, 'Módulo 1', 'Introducción al color y forma', 'jpg', 'https://example.com/pintura/color.jpg', '2025-06-01'),
(7, 7, 'Módulo 1', 'Qué es la Administración', 'pdf', 'https://example.com/administracion/intro.pdf', '2025-06-01'),
(8, 8, 'Módulo 1', 'Trazos básicos en caligrafía', 'svg', 'https://example.com/caligrafia/trazos.svg', '2025-06-01'),
(9, 9, 'Módulo 1', 'Cuidados esenciales para uñas', 'mp4', 'https://example.com/manicuria/cuidados.mp4', '2025-06-01'),
(10, 1, 'Módulo 2', 'Herramientas Manuales y Seguridad', 'pdf', 'https://example.com/carpinteria/herramientas.pdf', '2025-06-08'),
(11, 2, 'Módulo 2', 'Diseño para medios digitales', 'canva', 'https://canva.com/diseno/modulo2', '2025-06-08'),
(12, 3, 'Módulo 2', 'Procesadores de texto', 'docx', 'https://example.com/informatica/procesadores.docx', '2025-06-08'),
(13, 4, 'Módulo 2', 'Sistema de Frenos', 'mp4', 'https://example.com/mecanica/frenos.mp4', '2025-06-08'),
(14, 5, 'Módulo 2', 'Control del lenguaje corporal', 'pptx', 'https://example.com/oratoria/corporal.pptx', '2025-06-08'),
(15, 6, 'Módulo 2', 'Técnicas con acrílico', 'jpg', 'https://example.com/pintura/acrilico.jpg', '2025-06-08'),
(16, 7, 'Módulo 2', 'Planificación estratégica', 'pdf', 'https://example.com/administracion/planificacion.pdf', '2025-06-08'),
(17, 8, 'Módulo 2', 'Estilos modernos de caligrafía', 'svg', 'https://example.com/caligrafia/estilos.svg', '2025-06-08'),
(18, 9, 'Módulo 2', 'Esmaltado semipermanente', 'mp4', 'https://example.com/manicuria/esmaltado.mp4', '2025-06-08');
...
CREATE TABLE `Cursos` (
  ...
  `tipo` enum('gratuito','arancelado','capacitacion','en linea') DEFAULT NULL,
...
(1, 'Carpintería', 'Este curso de carpintería está diseñado para enseñar desde lo básico hasta lo avanzado. Aprende a manejar las herramientas y técnicas más importantes para crear proyectos de carpintería con precisión y seguridad.', 60, 'capacitacion', 3000.00, '2025-05-06', '2025-07-06', '/uploads/carpinteria.png'),
(2, 'Diseño', 'Para aquellos interesados en desarrollar habilidades en la creación y desarrollo de proyectos visuales impactantes. Aprenderás las herramientas y técnicas esenciales para diseñar piezas gráficas para una amplia gama de medios, desde impresos hasta digitales.', 45, 'gratuito', 8000.00, '2025-06-01', '2025-07-15', '/uploads/diseno.png'),
(3, 'Informática', 'Dirigido a personas que desean aprender a utilizar las herramientas informáticas esenciales para la vida diaria, el trabajo y la educación. A través de este curso, adquirirás conocimientos fundamentales sobre el uso de la computadora, programas de oficina y navegación en internet, lo que te permitirá desenvolverte con confianza en un mundo digital.', 90, 'arancelado', 9000.00, '2025-05-15', '2025-08-15', '/uploads/informatica.png'),
(4, 'Mecánica', 'Principios fundamentales de la reparación y mantenimiento de vehículos. Este curso te proporcionará las herramientas y conocimientos esenciales para entender el funcionamiento de los motores, los sistemas de transmisión, frenos, suspensión, y mucho más. Ya sea que busques aprender para uso personal o como base para una carrera en la mecánica, este curso es el primer paso hacia el mundo automotriz.', 75, 'capacitacion', 15000.00, '2025-06-10', '2025-08-24', '/uploads/mecanica.png'),
(5, 'Oratoria', 'Mejora tus habilidades de comunicación y aprende a expresarse de manera efectiva frente a cualquier tipo de audiencia. A lo largo de este curso, desarrollarás herramientas y técnicas para hablar con claridad, seguridad y persuasión, ya sea en presentaciones profesionales, exposiciones académicas o situaciones cotidianas donde se requiere hablar en público.', 30, 'gratuito', 20000.00, '2025-05-20', '2025-06-19', '/uploads/oratoria.png'),
(6, 'Pintura', 'Dirigido a todas las personas que deseen iniciarse en el arte de pintar o perfeccionar sus habilidades artísticas. A través de un enfoque práctico y dinámico, aprenderás a expresarte mediante el color, la forma y la técnica, explorando distintos estilos y materiales. Durante el curso, desarrollarás tu creatividad, conocerás las bases del dibujo, el manejo del color y las técnicas esenciales para trabajar con acrílicos, óleos y acuarelas, adaptándote a tu propio estilo personal.', 40, 'arancelado', 20000.00, '2025-07-01', '2025-08-10', '/uploads/pintura.png'),
(7, 'Administración', 'Ofrece una formación práctica y actualizada para quienes buscan adquirir o perfeccionar habilidades en la gestión de organizaciones. Aprenderás a planificar, organizar, dirigir y controlar recursos de manera eficiente, desarrollando una visión estratégica que te permita liderar proyectos, empresas o emprendimientos exitosamente. Ideal para quienes desean fortalecer su perfil profesional, emprender o mejorar la gestión de sus negocios.', 60, 'capacitacion', 18000.00, '2025-05-10', '2025-07-10', '/uploads/administracion.png'),
(8, 'Caligrafía', 'Para introducirte en el mundo de la escritura artística, combinando técnica y creatividad. Aprenderás a dominar distintos estilos caligráficos, mejorar tu trazo, desarrollar precisión y expresar tu estilo personal a través de la letra escrita. Es ideal tanto para principiantes como para quienes buscan perfeccionar su técnica en proyectos creativos, diseño, invitaciones, arte y más.', 20, 'gratuito', 12000.00, '2025-06-05', '2025-06-25', '/uploads/caligrafia.png'),
(9, 'Manicuría', 'Te formarás en las técnicas esenciales para el cuidado y embellecimiento de manos y uñas. Aprenderás desde los conceptos básicos de higiene y preparación hasta las últimas tendencias en esmaltado, decoración y tratamientos de spa para manos. Ideal para quienes desean iniciar su propio emprendimiento o perfeccionar sus habilidades en el mundo de la estética.', 50, 'capacitacion', 15000.00, '2025-05-22', '2025-07-11', '/uploads/manicuria.png'),
(10, 'Ingles-7', 'fe rpueba', 1, 'arancelado', 1000.00, '2025-06-06', '2025-08-05', '/uploads/Ingles-7_1748840601355.jpg');
...
CREATE TABLE `mensajes` (
  `id` int(11) NOT NULL,
  `client_offset` varchar(255) NOT NULL,
...
INSERT INTO `mensajes` (`id`, `client_offset`, `createdAt`, `updatedAt`, `content`) VALUES
(1, 'undefined-1748915106510', '2025-06-03 02:08:12', '2025-06-03 02:08:12', 'hola'),
(2, 'Qk3uTNnsXA8tRJQhAAAB-1748916507021', '2025-06-03 02:08:27', '2025-06-03 02:08:27', 'hola');
...
(1, 3, 1, 3000.00, '2025-06-01'),
(2, 3, 5, 20000.00, '2025-06-01'),
(3, 3, 5, 20000.00, '2025-06-01'),
(4, 3, 5, 20000.00, '2025-06-01'),
(5, 2, 1, 3000.00, '2025-06-01'),
(6, 1, 4, 15000.00, '2025-06-01'),
(7, 1, 2, 8000.00, '2025-06-01'),
(8, 3, 1, 3000.00, '2025-06-03');
...
(1, 'Admin', 'Principal', '1990-01-01', 'Base', 123456789, 'adminroot@gmail.com', '$2b$10$51ScMcajX3wKQyOSvN00EuyEzpvKy3efmUyC6nxbypIF6wxK56bee', 12345678, 'Administrador del sistema', 'docente', '/uploads/12345678-admin.png'),
(2, 'Carlos', 'Ramírez', '2000-04-15', 'Av. Siempre Viva 77', 123456789, 'carlosRamirez@gmail.com', '$2b$10$COYdDH.HB6tcqav01KkTeu6lqWy11QzQXMduiQrP00Ijec2MLL5BS', 42225678, 'Matemáticas', 'docente', '/uploads/profesor2.png'),
(3, 'Laura', 'González', '1995-08-25', 'Sprinfield 654', 987654321, 'lauraGonzalez@gmail.com', '$2b$10$FcjD3/crEEahJxFZS9XeReRTHPdu7uq//IIwZTljsV82icAegAwcq', 38226543, NULL, 'alumno', '/uploads/laura.jpg'),
(6, 'Hector Fernando', 'Calisaya', '1900-01-01', 'No proporcionada', 322511111, 'legasy23dream@gmail.com', '$2b$10$gLBgtD8WEkHhnktp.a/.NOWVxkvp.cs5lcDuLHzALV9rUFLy..zR.', 33777777, NULL, 'alumno', 'https://avatars.githubusercontent.com/u/205468351?v=4');
...
ALTER TABLE `mensajes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `client_offset` (`client_offset`);
